...
class AslCnnRnnModel(pl.LightningModule):
    def __init__(self, input_shape, hidden_dim, num_classes, n_layers, learning_rate=3e-4):
        ...
        # RNN 
        self.rnn = nn.LSTM(input_size=256, hidden_size=hidden_dim, num_layers=n_layers, batch_first=True)
...
class AslCnnRnnModel2(pl.LightningModule):
    def __init__(self, hidden_dim, num_classes, n_layers, learning_rate=3e-4):
